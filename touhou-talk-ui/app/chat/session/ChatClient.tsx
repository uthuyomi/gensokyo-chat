...
export default function ChatClient() {
  ...
  const chatUi = useMemo(() => ({
    room: lang === "ja" ? "ルーム" : "Room",
    chooseCharacter: lang === "ja" ? "キャラクターを選択" : "Choose a character",
    sessionShow: lang === "ja" ? "セッションIDを表示" : "Show session ID",
    sessionHide: lang === "ja" ? "セッションIDを隠す" : "Hide session ID",
    groupRosterShow: lang === "ja" ? "参加者を表示" : "Show participants",
    groupRosterHide: lang === "ja" ? "参加者を隠す" : "Hide participants",
    participants: lang === "ja" ? "参加者" : "Participants",
    cast: lang === "ja" ? "キャスト" : "Cast",
    lead: lang === "ja" ? "先頭" : "Lead",
    topic: lang === "ja" ? "話題" : "Topic",
    recentTurns: lang === "ja" ? "最近の流れ" : "Recent turns",
    nextCandidate: lang === "ja" ? "次" : "Next",
    continueTitle: lang === "ja" ? "AIルームの会話を続ける" : "Let the AI room continue",
    continue: lang === "ja" ? "続ける" : "Continue",
    autoRunTitle: lang === "ja" ? "AIルームの会話を自動進行する" : "Auto-run the AI room",
    autoRunOn: lang === "ja" ? "自動進行中" : "Auto-running",
    autoRunOff: lang === "ja" ? "自動進行" : "Auto-run",
    resizeAvatarPanel: lang === "ja" ? "アバターパネルの幅を調整" : "Resize avatar panel",
    resizeByDrag: lang === "ja" ? "ドラッグでサイズ変更。ダブルクリックでリセット。" : "Drag to resize. Double-click to reset.",
    character: lang === "ja" ? "キャラクター" : "Character",
    avatarArea: lang === "ja" ? "3:4固定のVRM表示エリア" : "VRM display area with a fixed 3:4 portrait ratio",
    dragMove: lang === "ja" ? "ドラッグで移動。ダブルクリックでサイズをリセット。" : "Drag to move. Double-click to reset size.",
    avatar: lang === "ja" ? "アバター" : "Avatar",
    hideAvatar: lang === "ja" ? "アバターを隠す" : "Hide avatar",
    dragResize: lang === "ja" ? "ドラッグでサイズ変更" : "Drag to resize",
    empty: lang === "ja" ? "左のサイドバーからキャラクターを選択してください。" : "Choose a character from the left sidebar.",
  }), [lang]);
