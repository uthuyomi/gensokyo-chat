        ...
        *,
        ...
        try:
            ...
            cleaned, clean_meta = sanitize_reply_text(
                ...
                suppress_markdown_headings=bool(getattr(roleplay_policy, "suppress_markdown_headings", False)),
                suppress_trailing_choice_prompt=bool(getattr(roleplay_policy, "suppress_trailing_choice_prompt", False)),
                brief_meta_refusal=bool(getattr(roleplay_policy, "brief_meta_refusal", False)),
                user_text=str(getattr(req, "message", "") or ""),
