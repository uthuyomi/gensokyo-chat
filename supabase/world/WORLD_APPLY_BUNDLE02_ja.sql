-- AUTO-GENERATED JA BUNDLE: WORLD_APPLY_BUNDLE02_ja.sql

-- BEGIN WORLD_APPLY_BUNDLE02.sql
...
-- END WORLD_APPLY_BUNDLE02.sql

-- BEGIN WORLD_LOCALIZE_JA_MASTERS.sql
...
-- END WORLD_LOCALIZE_JA_MASTERS.sql

-- BEGIN WORLD_LOCALIZE_JA.sql
